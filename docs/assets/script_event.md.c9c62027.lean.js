import{_ as s,v as a,b as n,R as l}from"./chunks/framework.f4f52a19.js";const y=JSON.parse('{"title":"事件","description":"","frontmatter":{},"headers":[],"relativePath":"script/event.md","filePath":"script/event.md"}'),p={name:"script/event.md"},t=l(`<h1 id="事件" tabindex="-1">事件 <a class="header-anchor" href="#事件" aria-label="Permalink to &quot;事件&quot;">​</a></h1><p>事件是呈现故事的主体。在剧本文件中，事件需要具有独特的事件名称，每个事件中含有一个或者多个执行项。</p><p>剧本文件中事件的放置形式如下：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="ope" tabindex="-1">ope <a class="header-anchor" href="#ope" aria-label="Permalink to &quot;ope&quot;">​</a></h2><p>内置支持的公式，具体如何书写请查阅<a href="/enumadv/script/ope.html">ope语句</a></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>
<span class="line"><span style="color:#A6ACCD;">    &quot;type&quot;: &quot;ope&quot;,</span></span>
<span class="line"><span style="color:#A6ACCD;">    &quot;if&quot;:&quot;执行条件&quot;,</span></span>
<span class="line"><span style="color:#A6ACCD;">    &quot;ope&quot;: [</span></span>
